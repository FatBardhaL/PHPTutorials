...
<?php
    ...
    if(isset($_POST['user_input'])&&!empty($_POST['user_input'])){
        ...
        $user_input_lc = strtolower($user_input);//I kthejm inputet ne shkronja te vogla
        $usre_input_new = str_replace($find,$replace,$user_input_lc);
        echo $usre_input_new;
    }
...
<form action="f84_comment_area.php" method="POST">

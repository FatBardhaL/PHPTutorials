<?php
	...
	if (isset($_GET['source'])) {
		...
		$watermark = imagecreatefrompng('images.jpeg');
		...
		imagecopymerge($image, $watermark,10,10,0,0,300,300, 60);
			//imagejpeg()=nderton nje jpeg file nga imazhi i dhene:
			//imagejpeg($image,$emriIfajllit.'')
		imagejpeg($image,$source.'watermarked.jpeg');
	}

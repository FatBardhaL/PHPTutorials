			...
			if($query_run = mysqli_query($conn,$query)){
				...
				if($query_num_rows==0){
					...
					while ($row = mysqli_fetch_assoc($query_run)){
						...
						//Ketu e ruajm $user_id(apo ID e selektuar) dhe pastaj e dergojm ne f116_LogOut_Index.php
						$_SESSION['user_id']=$user_id;
						if (isset($_SESSION['user_id'])) {
							//header('Location: f116_LogOut_Index.php');
							echo("<script>location.href = 'f117_LogOut_Index.php';</script>");
						}else{
...
?>
<!-- <?php  //echo $current_file;?> kjo lidhet me  f116_LogOut_Index.php -->
<!-- sepse ne f116_LogOut_Index.php gjendet include 'f116_LogOut_Form.php';-->
...
<a type="submit" href="f117_Register_Form.php">

			...
			if($query_run = mysqli_query($conn,$query)){
				...
				if($query_num_rows==0){
					...
					while ($row = mysqli_fetch_assoc($query_run)){
						...
						//Ketu e ruajm $user_id(apo ID e selektuar) dhe pastaj e dergojm ne f115_LogOut_Index.php
						$_SESSION['user_id']=$user_id;
						if (isset($_SESSION['user_id'])) {
							//header('Location: f115_LogOut_Index.php');
							echo("<script>location.href = 'f115_LogOut_Index.php';</script>");
						}else{
...
?>
<!-- <?php  //echo $current_file;?> kjo lidhet me  f115_LogOut_Index.php -->
<!-- sepse ne f115_LogOut_Index.php gjendet include 'f115_LogOut_Form.php';-->
